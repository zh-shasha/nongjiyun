...
public class QuickQuestionRecordVideo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quick_question_record_video);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {//用户按下拍摄按钮
                    ...
                    if (mRecorderView.getTimeCount() > 3){//判断用户按下时间是否大于3秒
                        ...
                        Toast.makeText(QuickQuestionRecordVideo.this, "视频录制时间太短", Toast.LENGTH_SHORT).show();
                    }
                }
                return true;
            }
