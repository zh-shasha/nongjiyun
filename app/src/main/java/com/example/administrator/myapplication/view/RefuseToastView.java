...
public class RefuseToastView extends View {
    //矩形，设置toast布局时用
    ...
    private void initPaint() {
        ...
        mPaint.setColor(Color.parseColor("#EEC900"));
    ...
    public RefuseToastView(Context context) {
        super(context);
    }

    public RefuseToastView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public RefuseToastView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
