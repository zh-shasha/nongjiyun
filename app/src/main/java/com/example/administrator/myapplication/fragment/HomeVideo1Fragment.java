...
public class HomeVideo1Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        videoMenus.add(new HomeVideoMenu(R.mipmap.iv_video3,"球根花卉种类及生产技术要点",Home_MediaPlayer.class));
        videoMenus.add(new HomeVideoMenu(R.mipmap.iv_video4,"农村电商发展及案例解析",Home_MediaPlayer.class));
        videoMenus.add(new HomeVideoMenu(R.mipmap.iv_video1,"球根花卉种类及生产技术要点",Home_MediaPlayer.class));
        videoMenus.add(new HomeVideoMenu(R.mipmap.iv_video2,"农村电商发展及案例解析",Home_MediaPlayer.class));
        videoMenus.add(new HomeVideoMenu(R.mipmap.iv_video3,"球根花卉种类及生产技术要点",Home_MediaPlayer.class));
        videoMenus.add(new HomeVideoMenu(R.mipmap.iv_video4,"农村电商发展及案例解析",Home_MediaPlayer.class));
