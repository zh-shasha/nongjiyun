...
public class Knowledge_Menu_Pro_Rice_DirAdapter extends BaseAdapter {
    private List<Knowledge_Menu_Pro_Rice_Dir> list;
    private Context context;
    public Knowledge_Menu_Pro_Rice_DirAdapter (List<Knowledge_Menu_Pro_Rice_Dir> list, Context context){
