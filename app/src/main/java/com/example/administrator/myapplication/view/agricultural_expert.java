...
public class agricultural_expert extends AppCompatActivity implements View.OnClickListener {
    ...
    private void init() {
        ...
        expertMenu.add(new HomeMenu(R.mipmap.tejing_technology, "特粮特经", null));
        expertMenu.add(new HomeMenu(R.mipmap.shucai_technology, "蔬菜", null));
        expertMenu.add(new HomeMenu(R.mipmap.guoshu, "果树", null));
        expertMenu.add(new HomeMenu(R.mipmap.zhibao, "植保", null));
        expertMenu.add(new HomeMenu(R.mipmap.shengzhu_technology, "生猪", null));
        ...
        expertMenu.add(new HomeMenu(R.mipmap.chaye_technology, "茶叶", null));
